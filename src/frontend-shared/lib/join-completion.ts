...
const SQL_KEYWORDS = new Set([
	"ON", "INNER", "LEFT", "RIGHT", "FULL", "CROSS", "NATURAL", "OUTER",
	"WHERE", "GROUP", "ORDER", "HAVING", "LIMIT", "OFFSET", "UNION",
	"EXCEPT", "INTERSECT", "SET", "INTO", "VALUES", "SELECT", "FROM",
	"JOIN", "AND", "OR", "NOT", "IN", "IS", "NULL", "AS", "BETWEEN",
...
export function buildJoinCompletions(
	...
	for (const ref of tableRefs) {
		...
		const refFks: ReferencingForeignKeyInfo[] =
			schemaData.referencingForeignKeys[key] ?? [];
